...
because its free tier only pauses after 7 days of _zero_ activity, with
...
**Updating later**: `scp` the changed files up again, then `pm2 restart signal-signage`.
...
- **Voiceover over an image or video**: open an image or video slide's
  ...
  can have a video's own audio _or_ a voiceover, not both at once (the
